...
// Usage: node migrations/set_admin_user.mjs [email]
// Example: node migrations/set_admin_user.mjs user@example.com
...
// Use require for dotenv since we're mixing ES modules and CommonJS
let dotenv;
try {
...
if (!email) {
  ...
  console.error('Usage: node migrations/set_admin_user.mjs [email]');
  console.error('Example: node migrations/set_admin_user.mjs user@example.com');
  process.exit(1);
}
